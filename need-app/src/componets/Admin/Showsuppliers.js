...
export default class Showsuppliers extends Component {
  constructor(props) {
    super(props);
          ...
          <div id="portfolio">
            <div className="container showtop  login-second ">
              <div className="page-title text-center">
                <h1 className="text-dark">Supplier</h1>
                  ...
                  <div className=" tabletrans ">
                    <div className="well">
                      ...
                      <table className="table table-hover">
                        ...
                        {this.state.users.map((supplier) => (
                          <tr>
                            <td className="tbld">
                              <img
                                src={`data:image/png;base64,${supplier.img}`}
                                alt=""
                                width="150px"
                                height="100px"
                              ></img>
                            </td>
                            <td className="tbld text-dark">{supplier.name}</td>
                            <td className="tbld text-dark">{supplier.description}</td>
                            <td className="tbld text-dark">{supplier.website}</td>
                            <td className="tbld text-dark">{supplier.phone}</td>
                            <td className="tbld text-dark">{supplier.email}</td>
                            <td className="tbld text-dark">{supplier.address}</td>
                            ...
                            <td className="d-flex justify-content-center tbld">
                              <div className="btn-group ">
                                <a
                                  ...
                                  value={supplier._id}
                                  onClick={(e) =>
                                    this.onDeleteUser(supplier._id, e)
                                  }
                                >
